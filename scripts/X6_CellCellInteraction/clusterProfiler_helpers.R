...
format_go_names <- function(go_names) {
  ...
  go_names[go_names=="e2f targets"] = "E2F targets"
  go_names[go_names=="cell cycle g1 s phase transition"] = "cell cycle G1-S phase transition"
  go_names[go_names=="myc targets v1"] = "Myc targets v1"
  go_names[go_names=="g2m checkpoint"] = "G2M checkpoint"
  return(go_names)
}
